    ...
    <form name="joinform" method="post" autocomplete="off">
      <fieldset>
        <table class="table">
          ...
          <tr>
            ...
            <td>
              <label for="instruction">영문자, 숫자,_만 입력 가능. 최소 3자이상 입력하세요.</label><br>
      ...
      <fieldset>
        <table class="table">
          ...
          <tr>
            ...
            <td>
              <label id="instruction2">공백없이 한글, 영문 숫자만 입력 가능(한글 2자, 영문 4자 이상)<br>닉네임을 바꾸시면 앞으로 1일 이내에는 변경할 수 없습니다.</label><br>
          ...
          <tr>
            ...
            <td>
              <div class="route">
                ...
                <label>주변사람소개</label>
                <input type="radio" name="route" id="route" value="etc" onclick="etcShowHide()">
                <label>기타</label>
                <input type="text" name="input_etc" id="input_etc" value="ggg">
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              <input type="button" value="주소 검색" id="searchaddr"><br>
      ...
      <fieldset>
        <table class="table">
          ...
          <tr>
            <td>
              <label for="kakaotalk"><b>카카오톡 메세지</b></label>
            </td>
            <td>
          ...
          <tr>
            <td>
              <label for="information"><b>정보공개</b></label>
            </td>
            <td>
        ...
        <div class="d-flex gap-2 justify-content-center">
          ...
          <input type="reset" class="btn btn-secondary btn-sm" value="가입취소" id="btn_secure_can">
        </div>
      </fieldset>
